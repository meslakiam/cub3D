...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   create_animation_imgs.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: oel-bann <oel-bann@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/19 12:08:19 by oel-bann          #+#    #+#             */
/*   Updated: 2025/09/24 00:13:09 by oel-bann         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../cube3d_bonus.h"

t_img	*get_gun_fire_pathlst(void)
{
	static t_img	*fire_path_lst;

	if (!fire_path_lst)
		count_img("Bonus/textures/gun_fire/", &fire_path_lst);
	return (fire_path_lst);
}

t_data_list	*get_gun_fire_imgs(int flag)
{
	...
	if (!fire_lst)
	{
		fire_path_lst = get_gun_fire_pathlst();
		while (fire_path_lst)
		{
