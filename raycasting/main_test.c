...
// // 		{
// // 			if (map[col][row] == '1')
// // 				draw_square(row * PIXEL, col * PIXEL, 0x00404040); // Dark Gray wall
// // 			else if (map[col][row] == '0' || map[col][row] == 'P')
// // 			{
// //             	draw_square(row * PIXEL, col * PIXEL, 0x00F5F5DC); // Light Beige floor
// //                 if( !first && map[col][row] == 'P')
// //                 {
// //                     first = 1;
// //                     v_player()->p_row = 0;
// //                     v_player()->p_x = 0 * PIXEL;
// //                     v_player()->p_col = 0;
// //                     v_player()->p_y = 0 * PIXEL;
// //                 }
// //             }
// //         	row++;
// // 		}
